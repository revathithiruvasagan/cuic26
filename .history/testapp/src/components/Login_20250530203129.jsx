...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Log the form data as JSON to console
      console.log('Login Data:', JSON.stringify(formData, null, 2));
      
      // Simulate API call
      const result = await loginUser(formData);
      
      if (result.success) {
        setMessage({ type: 'success', text: 'Login successful! Check console for data.' });
